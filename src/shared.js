...
const DOM_REPLACEMENT_DISABLED_DOMAINS = [
  ...
  "xero.com",
  "freshbooks.com",
  // Marketing, analytics, and ad-platform consoles. A vendor's dashboard is a
  // product surface even when its tracking domains are blocked third-party at
  // the network layer, and console UIs are saturated with ad-bearing class
  // names — the same false-positive shape as the Google-bar bug.
  "taboola.com",
  "outbrain.com",
  "criteo.com",
  "rubiconproject.com",
