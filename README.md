...
not have to press anything for that. The overlay then offers **Open the issue
form**, which opens GitHub in a new tab for you to paste into. **Copy** is there
if your clipboard missed it, and **Copy this site's reports** hands back
everything saved for the site you are on.

The link carries nothing about your page. Query parameters travel in the request,
so a prefilled report would reach GitHub the moment the tab opened, before you
had read it — which is not what "nothing is ever sent" can mean. The clipboard
is the only thing carrying the report, and you decide where it goes.
...
Neither report flow uploads anything, and the extension never opens a
connection of its own. Reports stay in
